...
print(f"A cidade com maior índice de acidentes é a {codigo_maior_indice} com {maior_indice} acidentes")
print(f"A cidade com menor índice de acidentes é a {codigo_menor_indice} com {menor_indice} acidentes")
